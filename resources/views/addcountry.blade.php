...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div style="width:74%;" class="container-fluid">
  ...
  <li class="nav-item">
        <a style="color:#ffffff" class="nav-link active" href="{{ url("country") }}">
...
<div class="row">
    ...
    {{csrf_field()}}
       ...
       <div class="row">
        ...
        <input type="text" class="form-control" placeholder="enter Country name" name="Country" /></div>
        

        <div class="form-group col-md-4">
        <label for="inputEmail4">CountryCode</label>
        <input type="text" class="form-control" placeholder="enter CountryCode" name="CountryCode" /></div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Slug</label>
        <input type="text" class="form-control" placeholder="enter Slug" name="Slug" /></div>
       </div>
       ...
       <div class="row">
        ...
        <input type="text" class="form-control" placeholder="enter NewConfirmed" name="NewConfirmed" /></div> 

        <div class="form-group col-md-4">
        <label for="inputEmail4">Number of Total Confirmed :</label>
        <input type="int" class="form-control" placeholder="enter TotalConfirmed" name="TotalConfirmed" /></div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Number of New Deaths :</label>
        <input type="text" class="form-control" placeholder="enter NewDeaths" name="NewDeaths" /></div>
       </div>
       ...
       <div class="row">
        ...
        <input type="text" class="form-control" placeholder="enter TotalDeaths" name="TotalDeaths" /></div>

        <div class="form-group col-md-4">
        <label for="inputEmail4">Number of New Recovered :</label>
        <input type="text" class="form-control" placeholder="enter NewRecovered" name="NewRecovered" /></div>
        
        <div class="form-group col-md-4">
        <label for="inputEmail4">Number of Total Recovered :</label>
        <input type="text" class="form-control" placeholder="enter TotalRecovered" name="TotalRecovered" /></div>
